...
import {
  HighchartsChart, Chart, XAxis, YAxis, Title, Subtitle, Legend, LineSeries, SplineSeries, PlotBand
} from 'react-jsx-highcharts';
import {Tooltip} from "recharts";



class modalGraphic extends Component {
  constructor (props) {
    super(props);
      ...
      <div>
        <HighchartsChart plotOptions={plotOptions}>
          ...
          <YAxis minorGridLineWidth={0} gridLineWidth={0} alternateGridColor={null}>
            ...
            <SplineSeries name="Hestavollane" data={[0.2, 0.4, 0.6, 0.8]}/>
